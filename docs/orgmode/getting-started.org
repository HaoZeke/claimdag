...
- [[file:howto.org][How-to]]: pick the next node by critical path, archive finished work, drive the pane.
- [[file:reference.org][Reference]]: verbs, statuses, the snapshot file.
- [[file:explanation.org][Explanation]]: why a claim is a lease and a generation is a fence.
